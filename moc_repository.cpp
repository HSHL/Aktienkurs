...
static const char qt_meta_stringdata_repository[] = {
    "repository\0"
};
...
const QMetaObjectExtraData repository::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject repository::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_repository,
      qt_meta_data_repository, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &repository::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_repository))
